            ...
            <Card title="Thú cưng đang lưu trú">
                <div className="space-y-3">
                    {(
                        ...
                        <div
                            key={name}
                            className="cursor-pointer rounded-3xl border border-slate-200 p-4 transition hover:border-emerald-300 hover:shadow-sm"
                        >
            ...
            <Card title="Cập nhật nhật ký hôm nay">
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <Select
                        ...
                        options={["Bình thường", "Theo dõi thêm", "Bất thường"]}
                    />
