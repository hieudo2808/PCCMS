...
type BookingStatus = "Chờ tiếp nhận" | "Đã tiếp nhận" | "Đang lưu trú" | "Đã trả" | "Đã từ chối";
...
// ─── Mock Data ────────────────────────────────────────────────────────────────
const initialRequests: BoardingRequest[] = [
    {
        id: "1",
        code: "BRD-001",
    ...
    },
    {
        ...
        // BUG-B: Đổi từ "Đã tiếp nhận" → "Đang lưu trú" để khớp với BoardingLogPage (Mít đang ở ngày 5/5)
        status: "Đang lưu trú",
        createdAt: "01/05/2026 - 18:00",
    },
];

const STATUS_TONE: Record<BookingStatus, "amber" | "blue" | "green" | "red"> = {
    "Chờ tiếp nhận": "amber",
    "Đã tiếp nhận": "blue",
    "Đang lưu trú": "green",
    "Đã trả": "green",
...
export function BoardingReceptionPage() {
    const [requests, setRequests] = useState<BoardingRequest[]>(initialRequests);
