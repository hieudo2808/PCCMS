...
public class Invoice extends AuditableEntity {
    ...
    @Builder.Default
    private Long discountVnd = 0L;

    @Column(name = "tax_vnd", nullable = false)
    @Builder.Default
    private Long taxVnd = 0L;

    @Column(name = "total_amount_vnd", nullable = false)
    @Builder.Default
    private Long totalAmountVnd = 0L;

    @Column(name = "paid_amount_vnd", nullable = false)
    @Builder.Default
    private Long paidAmountVnd = 0L;
